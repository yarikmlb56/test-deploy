...
<div class="toc-wrapper">
    ...
    <div id="toc" class="toc-list-h1">
        <ul class="toc-list-h1">
            ...
            <li>
                <span data-href="#api-for-tax-calculator" class="toc-h1 toc-link"
                      data-title="API for Tax Calculator v0.0.2 alfa, Nov 2019">API for Tax Calculator v0.0.2 alfa, Nov 2019</span>

            </li>

            <li>
                <span data-href="#authentication" class="toc-h1 toc-link"
                      data-title="Authentication">Authentication</span>

            </li>

            <li>
                <span data-href="#api-for-tax-calculator-notification-template" class="toc-h1 toc-link"
                      data-title="Notification template">Notification template</span>
                ...
                <ul class="toc-list-h2">
                    ...
                    <li>
                        <span data-href="#update-template-" class="toc-h2 toc-link"
                              data-title="">Update template.</span>

                    </li>

                    <li>
                        <span data-href="#delete-template-" class="toc-h2 toc-link"
                              data-title="">Delete template.</span>

                    </li>

                    <li>
                        <span data-href="#send-notification-" class="toc-h2 toc-link"
                              data-title="">Send notification.</span>
            ...
            <li>
                <span data-href="#api-for-tax-calculator-account-management" class="toc-h1 toc-link"
                      data-title="Account Management">Account Management</span>

                <ul class="toc-list-h2">

                    <li>
                        <span data-href="#create-new-account-" class="toc-h2 toc-link"
                              data-title="">Create new account.</span>

                    </li>

                    <li>
                        <span data-href="#update-an-account" class="toc-h2 toc-link"
                              data-title="">Update an account</span>
                    ...
                    <li>
                        <span data-href="#get-a-link-for-resetting-account-password-" class="toc-h2 toc-link"
                              data-title="">Get a link for resetting account password.</span>
            ...
            <li>
                <span data-href="#api-for-tax-calculator-token-management" class="toc-h1 toc-link"
                      data-title="Token Management">Token Management</span>

                <ul class="toc-list-h2">

                    <li>
                        <span data-href="#get-active-tokens" class="toc-h2 toc-link"
                              data-title="">Get active tokens</span>
                    ...
                    <li>
                        <span data-href="#revoke-the-token-" class="toc-h2 toc-link"
                              data-title="">Revoke the token.</span>
            ...
            <li>
                <span data-href="#api-for-tax-calculator-contact-information" class="toc-h1 toc-link"
                      data-title="Contact Information">Contact Information</span>
            ...
            <li>
                ...
                <ul class="toc-list-h2">
                    ...
                    <li>
                        <span data-href="#update-location-" class="toc-h2 toc-link"
                              data-title="">Update location.</span>

                    </li>

                    <li>
                        <span data-href="#delete-location-" class="toc-h2 toc-link"
                              data-title="">Delete location.</span>

                    </li>

                    <li>
                        <span data-href="#standartize-location" class="toc-h2 toc-link" data-title="">Standartize location</span>
            ...
            <li>
                <span data-href="#api-for-tax-calculator-business-info" class="toc-h1 toc-link"
                      data-title="Business Info">Business Info</span>
            ...
            <li>
                <span data-href="#api-for-tax-calculator-product-catalog" class="toc-h1 toc-link"
                      data-title="Product Catalog">Product Catalog</span>
            ...
            <li>
                <span data-href="#api-for-tax-calculator-product" class="toc-h1 toc-link"
                      data-title="Product">Product</span>

                <ul class="toc-list-h2">

                    <li>
                        <span data-href="#lookup-products-from-the-defined-catalog-" class="toc-h2 toc-link"
                              data-title="">Lookup products from the defined catalog.</span>
                    ...
                    <li>
                        <span data-href="#update-the-product-" class="toc-h2 toc-link"
                              data-title="">Update the product.</span>
            ...
            <li>
                <span data-href="#api-for-tax-calculator-logging" class="toc-h1 toc-link"
                      data-title="Logging">Logging</span>

                <ul class="toc-list-h2">

                    <li>
                        <span data-href="#return-api-call-logs-" class="toc-h2 toc-link" data-title="">Return API call logs.</span>
            ...
            <li>
                <span data-href="#api-for-tax-calculator-transaction-journal" class="toc-h1 toc-link"
                      data-title="Transaction Journal">Transaction Journal</span>

                <ul class="toc-list-h2">

                    <li>
                        <span data-href="#get-transactions-" class="toc-h2 toc-link"
                              data-title="">Get transactions.</span>
            ...
            <li>
                <span data-href="#api-for-tax-calculator-transaction-management" class="toc-h1 toc-link"
                      data-title="Transaction Management">Transaction Management</span>
                ...
                <ul class="toc-list-h2">
                    ...
                    <li>
                        <span data-href="#get-transaction-" class="toc-h2 toc-link"
                              data-title="">Get transaction.</span>

                    </li>

                    <li>
                        <span data-href="#delete-transaction-" class="toc-h2 toc-link"
                              data-title="">Delete transaction.</span>
            ...
            <li>
                ...
                <ul class="toc-list-h2">
                    ...
                    <li>
                        <span data-href="#tocs_processingstatus" class="toc-h2 toc-link"
                              data-title="">ProcessingStatus</span>
                    ...
                    <li>
                        <span data-href="#tocs_productcatalog" class="toc-h2 toc-link"
                              data-title="">ProductCatalog</span>

                    </li>

                    <li>
                        <span data-href="#tocs_productcatalogs" class="toc-h2 toc-link"
                              data-title="">ProductCatalogs</span>
                    ...
                    <li>
                        <span data-href="#tocs_transactiontype" class="toc-h2 toc-link"
                              data-title="">TransactionType</span>
                    ...
                    <li>
                        <span data-href="#tocs_logrequest" class="toc-h2 toc-link" data-title="">LogRequest</span>

                    </li>

                    <li>
                        <span data-href="#tocs_logresponse" class="toc-h2 toc-link" data-title="">LogResponse</span>
...
<div class="page-wrapper">
    ...
    <div class="content">
        ...
        <blockquote>
            <p>Scroll down for code samples, example requests and responses. Select a language for code samples from the
                tabs above or the mobile navigation menu.</p>
        </blockquote>
        <p>Vertex API for Tax Calculator.</p>
        <p>Base URLs:</p>
        <ul>
            <li><a href="http://localhost:8004/">http://localhost:8004/</a></li>
        </ul>
        <p>Web: <a href="http://www.vertex.com">API Support</a>
        ...
        <ul>
            <li>API Key (apiKeyAuth)
                <ul>
                    <li>Parameter Name: <strong>apikey</strong>, in: header. API key to authorize requests.</li>
                </ul>
            </li>
        </ul>
        <h1 id="api-for-tax-calculator-notification-template">Notification template</h1>
        <h2 id="return-registered-templates-">Return registered templates.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/templates'</span>,
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/templates'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /templates</code></p>
        <p>Returns registered templates for current sale channel.</p>
        <blockquote>
      ...
      <span class="hljs-attr">"body"</span>: <span class="hljs-string">" Dear {name}, Your account is activated."</span>
        ...
        <table>
            ...
            <tr>
                <td>200</td>
                <td>OK</td>
                <td>Returns collectin of the templates for</td>
                <td></td>
            </tr>
            <tr>
                <td>current sale channel.</td>
                <td><a href="#schematemplates">Templates</a></td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Unable to find any template.</td>
        ...
        <h2 id="register-new-template-">Register new template.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/templates'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/templates'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /templates</code></p>
        <p>The endpoint is used to register new template
            for current sale channel.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
  ...
  <span class="hljs-attr">"body"</span>: <span class="hljs-string">" Dear {name}, Your account is activated."</span>
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Template is added successfully.</td>
                <td><a href="#schematemplate">Template</a></td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to register template.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            <tr>
                <td>404</td>
            ...
            <tr>
                <td>Template with the same name is already registered.</td>
                <td><a href="#schemaerrors">Errors</a></td>
                <td></td>
                <td></td>
            </tr>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/templates/{templateId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/templates/{templateId}'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /templates/{templateId}</code></p>
        <p>Returns template with defined id.</p>
        ...
        <p><strong>templateId</strong>: Template id.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
...
result = RestClient.patch <span class="hljs-string">'http://localhost:8004/templates/{templateId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.patch(<span class="hljs-string">'http://localhost:8004/templates/{templateId}'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>PATCH /templates/{templateId}</code></p>
        <p>Makes changes in the defined template.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
  ...
  <span class="hljs-attr">"body"</span>: <span class="hljs-string">" Dear {name}, Your account is activated."</span>
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Template is updated successfully.</td>
                <td><a href="#schematemplate">Template</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Unable to update template.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
...
result = RestClient.delete <span class="hljs-string">'http://localhost:8004/templates/{templateId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.delete(<span class="hljs-string">'http://localhost:8004/templates/{templateId}'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>DELETE /templates/{templateId}</code></p>
        <p>Deletes the defined template.</p>
  ...
  <span class="hljs-attr">"body"</span>: <span class="hljs-string">" Dear {name}, Your account is activated."</span>
        ...
        <table>
            ...
            <tr>
                <td>200</td>
                <td>OK</td>
                <td>Template is deleted successfully.</td>
                <td><a href="#schematemplate">Template</a></td>
            </tr>
            <tr>
                <td>404</td>
        ...
        <h2 id="send-notification-">Send notification.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/templates/{templateId}/send'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/templates/{templateId}/send'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /templates/{templateId}/send</code></p>
        <p>The endpoint is used to notify current <br>
            sale channel by e-mail.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
      ...
      <span class="hljs-attr">"value"</span>: <span class="hljs-string">"value"</span>
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Notification sent successfully.</td>
                <td></td>
            </tr>
            <tr>
                <td>Returns fulfilled message.</td>
                <td><a href="#schemamessage">Message</a></td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to send notification.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="create-new-account-">Create new account.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/accounts'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/accounts'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /accounts</code></p>
        <p>The endpoint is used to create new account.</p>
        <ul>
            <li>The endpoint can be invoked by platform
                in this case platform API key should be
                passed as token.
            </li>
            <li>Either the endpoint can be invoked without
  ...
  <span class="hljs-attr">"password"</span>: <span class="hljs-string">"password"</span>
        ...
        <table>
            ...
            <tr>
                <td>body</td>
                <td>body</td>
                <td><a href="#schemaaccount">Account</a></td>
                <td>true</td>
                <td>none</td>
            </tr>
            </tbody>
        ...
        <h4 id="detailed-descriptions">Detailed descriptions</h4>
        <p><strong>platform</strong>: Platform API key.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
  ...
  <span class="hljs-attr">"password"</span>: <span class="hljs-string">"password"</span>
        ...
        <table>
            ...
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to create account.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            <tr>
                <td>409</td>
        ...
        <h2 id="update-an-account">Update an account</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.patch <span class="hljs-string">'http://localhost:8004/accounts'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.patch(<span class="hljs-string">'http://localhost:8004/accounts'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>PATCH /accounts</code></p>
        <p>Updates account password.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
  ...
  <span class="hljs-attr">"password"</span>: <span class="hljs-string">"password"</span>
        ...
        <table>
            ...
            <tr>
                <td>204</td>
                <td>No Content</td>
                <td>Account updated successfully.</td>
                <td><a href="#schemaaccount">Account</a></td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to update account.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            <tr>
                <td>404</td>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/accounts/info'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/accounts/info'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /accounts/info</code></p>
        <p>Returns all account information which
            tax calculation requires for defined account.
            For sale platform email as a query can be
            used as an account identifier.</p>
        ...
        <h4 id="detailed-descriptions">Detailed descriptions</h4>
        <p><strong>email</strong>: Account identifier.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
    ...
    <span class="hljs-attr">"locations"</span>: [
      {
        ...
        <table>
            ...
            <tr>
                ...
                <td><a href="#schemaaccountinfo">AccountInfo</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Unable to find an account.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="get-a-link-for-resetting-account-password-">Get a link for resetting account password.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/accounts/{email}/resetPassword'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/accounts/{email}/resetPassword'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /accounts/{email}/resetPassword</code></p>
        <p>The endpoint is used to generate temporary link which
            can be used for resetting account password.</p>
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Link created successfully.</td>
                <td><a href="#schemalink">Link</a></td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to create a link.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            <tr>
                <td>409</td>
                <td>Conflict</td>
                <td>Unble to find account.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="get-active-tokens">Get active tokens</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/tokens'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/tokens'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /tokens</code></p>
        <p>Returns collection of active tokens for current sale point.</p>
        ...
        <table>
            ...
            <tr>
                ...
                <td>integer</td>
                <td>false</td>
                <td>Defines number of the records for single page.</td>
            </tr>
            </tbody>
        </table>
        <h4 id="detailed-descriptions">Detailed descriptions</h4>
        <p><strong>page</strong>: Defines page number.</p>
        <p><strong>size</strong>: Defines number of the records for single page.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
      ...
      <span class="hljs-attr">"created"</span>: <span class="hljs-string">"2019-08-23T12:23:56TZ2"</span>
        ...
        <table>
            ...
            <tr>
                ...
                <td>OK</td>
                <td>Returns token.</td>
                <td><a href="#schematokens">Tokens</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Unable to return tokens.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/tokens'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/tokens'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /tokens</code></p>
        <p>Creates a new token for API call.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
  ...
  <span class="hljs-attr">"created"</span>: <span class="hljs-string">"2019-08-23T12:23:56TZ2"</span>
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Returns a token.</td>
                <td><a href="#schematoken">Token</a></td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to create token.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="revoke-the-token-">Revoke the token.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.delete <span class="hljs-string">'http://localhost:8004/tokens/{token}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.delete(<span class="hljs-string">'http://localhost:8004/tokens/{token}'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>DELETE /tokens/{token}</code></p>
        <p>The method allows to deactivate the token.
            But a sale channel should have as minimum one
            token for production environment and one for sandbox.
            They can't be revoked.</p>
  ...
  <span class="hljs-attr">"created"</span>: <span class="hljs-string">"2019-08-23T12:23:56TZ2"</span>
        ...
        <table>
            ...
            <tr>
                <td>200</td>
                <td>OK</td>
                <td>The token revoken successfully.</td>
                <td><a href="#schematoken">Token</a></td>
            </tr>
            <tr>
                <td>404</td>
            ...
            <tr>
                <td>409</td>
                <td>Conflict</td>
                <td>Unable to revoke the last token.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="get-contact-information-">Get contact information.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/contacts'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/contacts'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /contacts</code></p>
        <p>The endpoint returns contact information.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
  ...
  <span class="hljs-attr">"lastName"</span>: <span class="hljs-string">"Luchkovskiy"</span>
        ...
        <table>
            ...
            <tr>
                <td>200</td>
                <td>OK</td>
                <td>Returns contact information.</td>
                <td><a href="#schemacontactinfo">ContactInfo</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Contact information not found.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="add-contact-information-">Add contact information.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/contacts'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/contacts'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /contacts</code></p>
        <p>The endpoint is used to add contact information.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
  ...
  <span class="hljs-attr">"lastName"</span>: <span class="hljs-string">"Luchkovskiy"</span>
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Contact information added successfully.</td>
                <td><a href="#schemacontactinfo">ContactInfo</a></td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to add contact information.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/contacts/{contactId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/contacts/{contactId}'</span>, headers = headers)
...
result = RestClient.patch <span class="hljs-string">'http://localhost:8004/contacts/{contactId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.patch(<span class="hljs-string">'http://localhost:8004/contacts/{contactId}'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>PATCH /contacts/{contactId}</code></p>
        <p>The endpoint is used to update contact information.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
  ...
  <span class="hljs-attr">"lastName"</span>: <span class="hljs-string">"Luchkovskiy"</span>
        ...
        <table>
            ...
            <tr>
                <td>204</td>
                <td>No Content</td>
                <td>Contact information updated successfully</td>
                <td><a href="#schemacontactinfo">ContactInfo</a></td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to update contact information.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            <tr>
                <td>404</td>
            ...
            <tr>
                <td>account or contact information not found.</td>
                <td><a href="#schemaerrors">Errors</a></td>
                <td></td>
                <td></td>
            </tr>
        ...
        <h2 id="get-account-locations-">Get account locations.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/locations'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/locations'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /locations</code></p>
        <p>The endpoint is used to fetch locations
            for current sale point.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
      ...
      <span class="hljs-attr">"addressLine1"</span>: <span class="hljs-string">"875 MANCILL MILL RD"</span>
        ...
        <table>
            ...
            <tr>
                <td>200</td>
                <td>OK</td>
                <td>Returns location collection</td>
                <td><a href="#schemalocations">Locations</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Locations not found.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/locations'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/locations'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /locations</code></p>
        <p>The endpoint is used to add location, place
            where the sale poit is operated.</p>
        <p>Any number of phisical locations and
            only one adminisrative location are possible.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
  ...
  <span class="hljs-attr">"errors"</span>: [
    {
      ...
      <span class="hljs-attr">"details"</span>: [
        <span class="hljs-string">"details string1"</span>,
        <span class="hljs-string">"details string2"</span>
      ]
    }
  ]
}
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Location added successfully</td>
                <td>None</td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to add location.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            <tr>
                <td>404</td>
            ...
            <tr>
                <td>Location is already added.</td>
                <td><a href="#schemaerrors">Errors</a></td>
                <td></td>
                <td></td>
            </tr>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/locations/{locationId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/locations/{locationId}'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /locations/{locationId}</code></p>
        <p>Returns location with defined id.</p>
        ...
        <h4 id="detailed-descriptions">Detailed descriptions</h4>
        <p><strong>locationId</strong>: Location Id.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
...
result = RestClient.patch <span class="hljs-string">'http://localhost:8004/locations/{locationId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.patch(<span class="hljs-string">'http://localhost:8004/locations/{locationId}'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>PATCH /locations/{locationId}</code></p>
        <p>The endpoint is used to update location.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
  ...
  <span class="hljs-attr">"addressLine1"</span>: <span class="hljs-string">"875 MANCILL MILL RD"</span>
        ...
        <table>
            ...
            <tr>
                <td>204</td>
                <td>No Content</td>
                <td>Location is updated successfully.</td>
                <td><a href="#schemalocation">Location</a></td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to update location.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            <tr>
                <td>404</td>
...
result = RestClient.delete <span class="hljs-string">'http://localhost:8004/locations/{locationId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.delete(<span class="hljs-string">'http://localhost:8004/locations/{locationId}'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>DELETE /locations/{locationId}</code></p>
        <p>The endpoint is used to delete location.
  ...
  <span class="hljs-attr">"addressLine1"</span>: <span class="hljs-string">"875 MANCILL MILL RD"</span>
        ...
        <table>
            ...
            <tr>
                <td>200</td>
                <td>OK</td>
                <td>Location deleted successfully.</td>
                <td><a href="#schemalocation">Location</a></td>
            </tr>
            <tr>
                <td>404</td>
        ...
        <h2 id="standartize-location">Standartize location</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/locations/standartize'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/locations/standartize'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /locations/standartize</code></p>
        <p>Validates location and return result in strandart format.
            It helps to keep addresses in unified format and
            find zip extension.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
  ...
  <span class="hljs-attr">"addressLine1"</span>: <span class="hljs-string">"875 MANCILL MILL RD"</span>
        ...
        <table>
            ...
            <tr>
                <td>200</td>
                <td>OK</td>
                <td>Returns location is standart format.</td>
                <td><a href="#schemalocation">Location</a></td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to validate defined location.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            <tr>
                <td>404</td>
            ...
            <tr>
                <td>Location has invalid format.</td>
                <td><a href="#schemaerrors">Errors</a></td>
                <td></td>
                <td></td>
            </tr>
        ...
        <h2 id="get-business-information-">Get business information.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/businessInfo'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/businessInfo'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /businessInfo</code></p>
        <p>Returns business information with for current sales point.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
  ...
  <span class="hljs-attr">"fedTaxId"</span>: <span class="hljs-string">"2321-2323-2132"</span>
        ...
        <table>
            ...
            <tr>
                <td>200</td>
                <td>OK</td>
                <td>Returns business information.</td>
                <td><a href="#schemabusinessinfo">BusinessInfo</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Business information not found.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="update-business-information-">Update business information.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.put <span class="hljs-string">'http://localhost:8004/businessInfo'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.put(<span class="hljs-string">'http://localhost:8004/businessInfo'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>PUT /businessInfo</code></p>
        <p>The endpoint is used to update business information.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
  ...
  <span class="hljs-attr">"fedTaxId"</span>: <span class="hljs-string">"2321-2323-2132"</span>
        ...
        <table>
            ...
            <tr>
                <td>204</td>
                <td>No Content</td>
                <td>Business information updated sucessfully.</td>
                <td><a href="#schemabusinessinfo">BusinessInfo</a></td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to update business information.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            <tr>
                <td>404</td>
        ...
        <h2 id="add-business-information-">Add business information.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/businessInfo'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/businessInfo'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /businessInfo</code></p>
        <p>The endpoint is used to add business information.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
  ...
  <span class="hljs-attr">"fedTaxId"</span>: <span class="hljs-string">"2321-2323-2132"</span>
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Business information added successfully.</td>
                <td><a href="#schemabusinessinfo">BusinessInfo</a></td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to add business information.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            <tr>
                <td>404</td>
            ...
            <tr>
                <td>Business infomatin aleready added.</td>
                <td><a href="#schemaerrors">Errors</a></td>
                <td></td>
                <td></td>
            </tr>
        ...
        <h2 id="return-available-product-catalogs-">Return available product catalogs.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/catalogs'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/catalogs'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /catalogs</code></p>
        <p>Returns product catalogs for current sale point.
            Usually it one.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
      ...
      <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>
        ...
        <table>
            ...
            <tr>
                <td>200</td>
                <td>OK</td>
                <td>Returns product catalog.</td>
                <td><a href="#schemaproductcatalogs">ProductCatalogs</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Unable to find product calalog.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="upload-and-validate-product-catalog-">Upload and validate product catalog.</h2>
        <p>Return a process status.</p>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/catalogs'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/catalogs'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /catalogs</code></p>
        <p>Uploads and validtes product catalog.
            Processing product catalog is an asynchronous process.
            Endpoint returns a link for checking process status.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
...
-responses">Responses</h3>
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Returns a link which is used for checking upload</td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to upload catalog.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Catalog has invalid structure.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="return-product-catalog">Return product catalog</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/catalogs/{catalogId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/catalogs/{catalogId}'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /catalogs/{catalogId}</code></p>
        <p>Returns product catalog with defined id.</p>
        ...
        <h4 id="detailed-descriptions">Detailed descriptions</h4>
        <p><strong>catalogId</strong>: Catalog id.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
  ...
  <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>
        ...
        <table>
            ...
            <tr>
                <td>200</td>
                <td>OK</td>
                <td>Return product catalog</td>
                <td><a href="#schemaproductcatalog">ProductCatalog</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Unable to find product catalog.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="remap-tax-categories-">Remap tax categories.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/catalogs/{catalogId}/map'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/catalogs/{catalogId}/map'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /catalogs/{catalogId}/map</code></p>
        <p>Remaps/Maps tax categories for new/updated products only.
            Processing product catalog is an asynchronous process.
            Endpoint returns a link for checking process status.</p>
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Returns a link which for checking process status.</td>
                <td><a href="#schemalink">Link</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Unable to find catalog.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="get-product-catalog-processing-status">Get product catalog processing status</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/catalogs/{processId}/status'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/catalogs/{processId}/status'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /catalogs/{processId}/status</code></p>
        <p>Processing product catalog is an asynchronous process.
            The endpoint returns product catalog processing status.</p>
        ...
        <h4 id="detailed-descriptions">Detailed descriptions</h4>
        <p><strong>processId</strong>: Process id.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
        ...
        <pre class="highlight tab tab-json"><code>{
  <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>,
  <span class="hljs-attr">"link"</span>: <span
                class="hljs-string">"http://192.168.0.17/api/v1.2/nextPage?size=12"</span>,
  <span class="hljs-attr">"status"</span>: <span class="hljs-string">"processing"</span>
        ...
        <table>
            ...
            <tr>
                <td>200</td>
                <td>OK</td>
                <td>Returns processing status.</td>
                <td><a href="#schemaprocessingstatus">ProcessingStatus</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Unable to return processing status.</td>
                <td></td>
            </tr>
            <tr>
                <td>Invalid process identifier.</td>
                <td><a href="#schemaerrors">Errors</a></td>
                <td></td>
                <td></td>
            </tr>
        ...
        <h2 id="accept-product-catalog-categorization-">Accept product catalog categorization.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/catalogs/{catalogId}/accept'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/catalogs/{catalogId}/accept'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /catalogs/{catalogId}/accept</code></p>
        <p>Accept product catalog categorization.</p>
      ...
      <span class="hljs-attr">"details"</span>: [
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Customer is agree with tax categorization.</td>
                <td>None</td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Invalid identifier, catalog not found</td>
                <td></td>
            </tr>
            <tr>
                <td>or processing is not finished.</td>
                <td><a href="#schemaerrors">Errors</a></td>
                <td></td>
                <td></td>
            </tr>
        ...
        <h2 id="download-product-catalog-">Download product catalog.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/catalogs/{catalogId}/load'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/catalogs/{catalogId}/load'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>POST /catalogs/{catalogId}/load</code></p>
        <p>Allows to download product catalogue for
            new/updated products only.</p>
  ...
  <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Returns a product catalog.</td>
                <td><a href="#schemaproductcatalog">ProductCatalog</a></td>
            </tr>
            <tr>
                <td>400</td>
                <td>Bad Request</td>
                <td>Unable to return catalogue.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Invalid product catalog identifier.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="lookup-products-from-the-defined-catalog-">Lookup products from the defined catalog.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/catalogs/{catalogId}/products'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/catalogs/{catalogId}/products'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /catalogs/{catalogId}/products</code></p>
        <p>Returns products from the specified catalog.
            Filtering is avilable by</p>
        <ul>
            <li>product name</li>
            <li>product category</li>
            <li>product identifier (MasterId/SKU/UPC)
        ...
        <table>
            ...
            <tr>
                ...
                <td>integer</td>
                <td>false</td>
                <td>Record number for single page.</td>
            </tr>
            <tr>
                <td>name</td>
                <td>query</td>
                <td>string</td>
                <td>false</td>
                <td>Filtering by product name.</td>
            </tr>
            <tr>
                <td>category</td>
                <td>query</td>
                <td>string</td>
                <td>false</td>
                <td>Filtering by product category.</td>
            </tr>
            <tr>
                <td>label</td>
                <td>query</td>
                <td>string</td>
                <td>false</td>
                <td>Filtering by label which could be MasterId/SKU/UPC.</td>
            </tr>
            <tr>
                <td>mappingType</td>
                <td>query</td>
                <td>string</td>
                <td>false</td>
                <td>Filtering by product mapping type.</td>
            </tr>
            </tbody>
        </table>
        <h4 id="detailed-descriptions">Detailed descriptions</h4>
        <p><strong>catalogId</strong>: Catalog id.</p>
        <p><strong>page</strong>: Page number</p>
        <p><strong>size</strong>: Record number for single page.</p>
        <p><strong>name</strong>: Filtering by product name.</p>
        <p><strong>category</strong>: Filtering by product category.</p>
        <p><strong>label</strong>: Filtering by label which could be MasterId/SKU/UPC.</p>
        <p><strong>mappingType</strong>: Filtering by product mapping type.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
  ...
  <span class="hljs-attr">"products"</span>: [
    {
      ...
      <span class="hljs-attr">"timestamp"</span>: <span class="hljs-string">"2019-12-12T13:19:09Z"</span>,
      <span class="hljs-attr">"mappingType"</span>: <span class="hljs-string">"autoMapped"</span>,
      <span class="hljs-attr">"effectivePeriod"</span>: {
        <span class="hljs-attr">"fromDate"</span>: <span class="hljs-string">"2019-12-12"</span>,
        <span class="hljs-attr">"toDate"</span>: <span class="hljs-string">"2019-12-12"</span>
      },
      <span class="hljs-attr">"taxCategories"</span>: [
        {
          <span class="hljs-attr">"id"</span>: <span class="hljs-number">556</span>,
      ...
      <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Returns collection of the products.</td>
                <td><a href="#schemaproducts">Products</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Product catalog not found.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="add-product-to-the-catalog-">Add product to the catalog.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.put <span class="hljs-string">'http://localhost:8004/catalogs/{catalogId}/products'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.put(<span class="hljs-string">'http://localhost:8004/catalogs/{catalogId}/products'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>PUT /catalogs/{catalogId}/products</code></p>
        <p>Adds product to the catalog.</p>
        <blockquote>
            <p>Body parameter</p>
        </blockquote>
        <pre class="highlight tab tab-json"><code>{
  ...
  <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>
        ...
        <h4 id="detailed-descriptions">Detailed descriptions</h4>
        <p><strong>catalogId</strong>: Catalog Id.</p>
        <p><strong>body</strong>: Product definition.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
  ...
  <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>
        ...
        <table>
            ...
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Unable to add product to catalog.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="return-the-product-from-the-catalog-">Return the product from the catalog.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/products/{productId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/products/{productId}'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /products/{productId}</code></p>
        <p>Returns the productby product id.</p>
  ...
  <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>
        ...
        <table>
            ...
            <tr>
                <td>201</td>
                <td>Created</td>
                <td>Returns the product</td>
                <td><a href="#schemaproduct">Product</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>The product not found.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="update-the-product-">Update the product.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.patch <span class="hljs-string">'http://localhost:8004/products/{productId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.patch(<span class="hljs-string">'http://localhost:8004/products/{productId}'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>PATCH /products/{productId}</code></p>
        <p>Make same changes in the product.</p>
  ...
  <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>
        ...
        <h2 id="return-api-call-logs-">Return API call logs.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/logs'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/logs'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /logs</code></p>
        <p>Returns API call logs for current sale point.</p>
        ...
        <table>
            ...
            <tr>
                ...
                <td>integer</td>
                <td>false</td>
                <td>Specified number of the logs for single page.</td>
            </tr>
            <tr>
                <td>fromDate</td>
                <td>query</td>
                ...
                <td>false</td>
                <td>Specified period, from date.</td>
            </tr>
            <tr>
                <td>toDate</td>
                <td>query</td>
                <td><a href="#schemadatetime">DateTime</a></td>
                <td>false</td>
                <td>Specified period, to date.</td>
            </tr>
            </tbody>
        </table>
        <h4 id="detailed-descriptions">Detailed descriptions</h4>
        <p><strong>page</strong>: Specified page number.</p>
        <p><strong>size</strong>: Specified number of the logs for single page.</p>
        <p><strong>fromDate</strong>: Specified period, from date.</p>
        <p><strong>toDate</strong>: Specified period, to date.</p>
        <blockquote>
            <p>Example responses</p>
        </blockquote>
        <blockquote>
  ...
  <span class="hljs-attr">"logs"</span>: [
    {
      <span class="hljs-attr">"request"</span>: {
        <span class="hljs-attr">"url"</span>: <span class="hljs-string">"http://vertex.com/api/v1.2/transactions/123?page=1"</span>,
        <span class="hljs-attr">"uri"</span>: <span class="hljs-string">"api/v1.2/transactions/123"</span>,
        <span class="hljs-attr">"query"</span>: <span class="hljs-string">"page=1"</span>,
        <span class="hljs-attr">"method"</span>: <span class="hljs-string">"GET"</span>
      },
      <span class="hljs-attr">"response"</span>: {
        <span class="hljs-attr">"code"</span>: <span class="hljs-string">"200"</span>,
        <span class="hljs-attr">"content"</span>: <span class="hljs-string">"log trace"</span>
      },
      <span class="hljs-attr">"date"</span>: <span class="hljs-string">"2019-12-12T13:19:09Z"</span>,
      <span class="hljs-attr">"correlationId"</span>: <span class="hljs-string">"string"</span>
    }
  ]
}
</code></pre>
        ...
        <table>
            ...
            <tr>
                ...
                <td>OK</td>
                <td>Returns logs</td>
                <td><a href="#schemalogs">Logs</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Unable to get logs by defined criterias.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/transactions'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/transactions'</span>, headers = headers)

print(r.json())

</code></pre>
        <p><code>GET /transactions</code></p>
        <p>Returns transactions for current sale point.
            Trnsactions can be selected by specified criteria.</p>
        ...
        <table>
            ...
            <tr>
                ...
                <td>integer</td>
                <td>false</td>
                <td>Number of the transactions for single page.</td>
            </tr>
            <tr>
                <td>states</td>
                <td>query</td>
                <td>string</td>
                <td>false</td>
                <td>Specified list of the states with comma delimitter.</td>
            </tr>
            <tr>
                <td>fromDate</td>
                <td>query</td>
        ...
        <h4 id="detailed-descriptions">Detailed descriptions</h4>
        <p><strong>page</strong>: Page number.</p>
        <p><strong>size</strong>: Number of the transactions for single page.</p>
        <p><strong>states</strong>: Specified list of the states with comma delimitter.</p>
        <p><strong>fromDate</strong>: Specified period, from date.</p>
        <p><strong>toDate</strong>: Specified period, to date.</p>
        <blockquote>
            <p>Example responses</p>
  ...
  <span class="hljs-attr">"transactions"</span>: [
    {
      ...
      <span class="hljs-attr">"order"</span>: {
        ...
        <span class="hljs-attr">"total"</span>: {
          <span class="hljs-attr">"total"</span>: <span class="hljs-string">"string"</span>,
          <span class="hljs-attr">"subTotal"</span>: <span class="hljs-string">"string"</span>,
          <span class="hljs-attr">"totalTax"</span>: <span class="hljs-string">"string"</span>,
      ...
      <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>
        ...
        <table>
            ...
            <tr>
                <td>200</td>
                <td>OK</td>
                <td>Returns transactions</td>
                <td><a href="#schematransactions">Transactions</a></td>
            </tr>
            <tr>
                <td>404</td>
                <td>Not Found</td>
                <td>Unable to get transactions with defined criterias.</td>
                <td><a href="#schemaerrors">Errors</a></td>
            </tr>
            </tbody>
        </table>
        ...
        <h2 id="get-transaction-summary-">Get Transaction Summary.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/transactions/summary'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/transactions/summary'</span>, headers = headers)
...
print(r.json())
  ...
  <span class="hljs-attr">"totalTax"</span>: <span class="hljs-number">34.3</span>
        ...
        <h2 id="download-journal-in-cvs-">Download journal in CVS.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/transactions/cvs'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/transactions/cvs'</span>, headers = headers)
  ...
  <span class="hljs-attr">"errors"</span>: [
    {
      ...
      <span class="hljs-attr">"details"</span>: [
        ...
        <h2 id="consume-transaction-">Consume transaction.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.post <span class="hljs-string">'http://localhost:8004/transactions'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.post(<span class="hljs-string">'http://localhost:8004/transactions'</span>, headers = headers)
...
result = RestClient.get <span class="hljs-string">'http://localhost:8004/transactions/{transactionId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.get(<span class="hljs-string">'http://localhost:8004/transactions/{transactionId}'</span>, headers = headers)
...
result = RestClient.delete <span class="hljs-string">'http://localhost:8004/transactions/{transactionId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.delete(<span class="hljs-string">'http://localhost:8004/transactions/{transactionId}'</span>, headers = headers)
...
print(r.json())
  ...
  <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>
        ...
        <h2 id="update-specified-transaction-">Update specified transaction.</h2>
        <blockquote>
            <p>Code samples</p>
        </blockquote>
        <pre class="highlight tab tab-ruby"><code><span class="hljs-keyword">require</span> <span class="hljs-string">'rest-client'</span>
...
result = RestClient.patch <span class="hljs-string">'http://localhost:8004/transactions/{transactionId}'</span>,
  <span class="hljs-symbol">params:</span> {
  }, <span class="hljs-symbol">headers:</span> headers
...
r = requests.patch(<span class="hljs-string">'http://localhost:8004/transactions/{transactionId}'</span>, headers = headers)
...
print(r.json())
  ...
  <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>
        ...
        <pre class="highlight tab tab-json"><code>{
  <span class="hljs-attr">"self"</span>: <span
                class="hljs-string">"http://vertex.com/api/v1.2/logs?page=30&amp;size=10"</span>,
  <span class="hljs-attr">"prev"</span>: <span
                class="hljs-string">"http://vertex.com/api/v1.2/logs?page=29&amp;size=10"</span>,
  <span class="hljs-attr">"next"</span>: <span
                class="hljs-string">"http://vertex.com/api/v1.2/logs?page=31&amp;size=10"</span>,
  <span class="hljs-attr">"first"</span>: <span
                class="hljs-string">"http://vertex.com/api/v1.2/logs?page=1&amp;size=10"</span>,
  <span class="hljs-attr">"last"</span>: <span
                class="hljs-string">"http://vertex.com/api/v1.2/logs?page=80&amp;size=10"</span>
}
        ...
        <table>
            ...
            <tr>
                ...
                <td>false</td>
                <td>none</td>
                <td>Absolute URI. <br/>Used for implementing UI on hypermedia way.</td>
            </tr>
            <tr>
                <td>prev</td>
                <td><a href="#schemalink">Link</a></td>
  ...
  <span class="hljs-attr">"errors"</span>: [
    {
      ...
      <span class="hljs-attr">"details"</span>: [
        ...
        <p><a id="schemadate"></a>
            ...
            <a id="tocSdate"></a>
            <a id="tocsdate"></a></p>
        <pre class="highlight tab tab-json"><code><span class="hljs-string">"2019-12-12"</span>
        ...
        <pre class="highlight tab tab-json"><code><span class="hljs-string">"2019-12-12T13:19:09Z"</span>
      ...
      <span class="hljs-attr">"value"</span>: <span class="hljs-string">"value"</span>
        ...
        <table>
            ...
            <tr>
                ...
                <td>false</td>
                <td>none</td>
                <td>[Definition of the notification parameter. <br/>Notification service uses parameters to fulfil <br/>defined
                    template by values.<br/>]
                </td>
            </tr>
            </tbody>
        </table>
  ...
  <span class="hljs-attr">"body"</span>: <span class="hljs-string">" Dear {name}, Your account is activated."</span>
        ...
        <table>
            ...
            <tr>
                ...
                <td>false</td>
                <td>none</td>
                <td>Definition of the notification template.</td>
            </tr>
            <tr>
                <td>name</td>
                <td>string</td>
            ...
            <tr>
                ...
                <td>false</td>
                <td>none</td>
                <td>Template body which should be HTML with data fileds placeholders.</td>
            </tr>
            </tbody>
        </table>
      ...
      <span class="hljs-attr">"body"</span>: <span class="hljs-string">" Dear {name}, Your account is activated."</span>
        ...
        <table>
            ...
            <tr>
                ...
                <td>false</td>
                <td>none</td>
                <td>[Definition of the notification template.<br/>]</td>
            </tr>
            </tbody>
        </table>
  ...
  <span class="hljs-attr">"id"</span>: <span class="hljs-number">0</span>
        ...
        <table>
            ...
            <tr>
                ...
                <td>false</td>
                <td>none</td>
                <td>Sale point/merchnt identifier.</td>
            </tr>
            <tr>
                <td>platformId</td>
                <td>integer</td>
  ...
  <span class="hljs-attr">"totalTax"</span>: <span class="hljs-number">34.3</span>
        ...
        <p><a id="schemalogrequest"></a>
            <a id="schema_LogRequest"></a>
            <a id="tocSlogrequest"></a>
            <a id="tocslogrequest"></a></p>
        <pre class="highlight tab tab-json"><code>{
  <span class="hljs-attr">"url"</span>: <span
                class="hljs-string">"http://vertex.com/api/v1.2/transactions/123?page=1"</span>,
  <span class="hljs-attr">"uri"</span>: <span class="hljs-string">"api/v1.2/transactions/123"</span>,
  <span class="hljs-attr">"query"</span>: <span class="hljs-string">"page=1"</span>,
  <span class="hljs-attr">"method"</span>: <span class="hljs-string">"GET"</span>
}
        ...
        <p><a id="schemalogresponse"></a>
            <a id="schema_LogResponse"></a>
            <a id="tocSlogresponse"></a>
            <a id="tocslogresponse"></a></p>
        <pre class="highlight tab tab-json"><code>{
  <span class="hljs-attr">"code"</span>: <span class="hljs-string">"200"</span>,
  <span class="hljs-attr">"content"</span>: <span class="hljs-string">"log trace"</span>
}
  ...
  <span class="hljs-attr">"correlationId"</span>: <span class="hljs-string">"string"</span>
        ...
        <table>
            ...
            <tr>
                <td>request</td>
                <td><a href="#schemalogrequest">LogRequest</a></td>
                <td>false</td>
                <td>none</td>
                <td>none</td>
            </tr>
            <tr>
                <td>response</td>
                <td><a href="#schemalogresponse">LogResponse</a></td>
                <td>false</td>
                <td>none</td>
                <td>none</td>
            </tr>
            ...
            <tr>
                ...
                <td>false</td>
                <td>none</td>
                <td>Unique identifier that helps to trace request.</td>
            </tr>
            </tbody>
        </table>
